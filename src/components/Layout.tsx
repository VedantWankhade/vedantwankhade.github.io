...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return <div className={`text-lg font-inter min-h-screen container flex flex-col justify-between max-w-full m-0 bg-ctp-base text-ctp-text ${theme}`}>
          <header className="p-6 bg-ctp-base animate-slide-down sticky top-0 z-10 bg-opacity-30 backdrop-blur-lg backdrop-filter border border-ctp-base">
          ...
          <div className={`border border-ctp-base bg-opacity-30 backdrop-blur-lg backdrop-filter ${slideMenuFlag} z-10 bg-ctp-mantle animate-slide-left right-0 p-4 bottom-0 w-1/4 h-screen fixed translate-x-0`}>
          ...
          <footer className="p-6 bg-ctp-base flex justify-between">
